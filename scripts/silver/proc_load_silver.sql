...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            END AS bdate,
            CASE 
                WHEN UPPER(REPLACE(REPLACE(REPLACE(LTRIM(RTRIM(gen)), CHAR(13), ''), CHAR(10), ''), CHAR(9), '')) IN ('F', 'FEMALE') THEN 'Female'
                WHEN UPPER(REPLACE(REPLACE(REPLACE(LTRIM(RTRIM(gen)), CHAR(13), ''), CHAR(10), ''), CHAR(9), '')) IN ('M', 'MALE') THEN 'Male'
                ELSE 'n/a'
            END AS gen
        ...
        SELECT
            ...
            CASE 
                ...
                WHEN REPLACE(REPLACE(REPLACE(cntry, CHAR(13), ''), CHAR(10), ''), ' ', '') = '' OR cntry IS NULL THEN 'n/a'
